...
void MeshAccessModule::UpdateMeshAccessBroadcastPacket(u16 advIntervalMs)
{
    ...
    AdvJob job = {
        ...
        5, //Slots
        0, //Delay
        (u16)MSEC_TO_UNITS((GS->node.isInBulkMode ? 40 : 20), CONFIG_UNIT_0_625_MS), //AdvInterval orginal 1000:100
        0, //AdvChannel
        0, //CurrentSlots
        0, //CurrentDelay
    ...
    if (advIntervalMs != 0)
    {
        currentJob->advertisingInterval = MSEC_TO_UNITS((GS->node.isInBulkMode ? 1000 : advIntervalMs), CONFIG_UNIT_0_625_MS); //orginal 1000
    }
