...
void Conf::LoadDefaults(){
...
#ifdef SIM_ENABLED
    totalInConnections = 3; // orginal 3 
    meshMaxInConnections = 3; // orginal 2 
#endif

    meshMinConnectionInterval = (u16)MSEC_TO_UNITS(400, CONFIG_UNIT_1_25_MS); //orginal 15 //這裡修改MinConnectionInterval
    meshMaxConnectionInterval = (u16)MSEC_TO_UNITS(400, CONFIG_UNIT_1_25_MS); //orginal 15 //這裡修改MaxConnectionInterval
    ...
    meshScanIntervalHigh = 640; //FIXME_HAL: 120 units = 75ms (0.625ms steps) //orginal 120 80 160 240 //這裡修改 ScanInterval
    meshScanWindowHigh = 160; //FIXME_HAL: 12 units = 7.5ms (0.625ms steps) //orginal 12 80 160 240 //這裡修改 ScanWindow

    meshScanIntervalLow = (u16)MSEC_TO_UNITS(640, CONFIG_UNIT_0_625_MS); //orginal 250 80 160 240 //這裡修改 ScanInterval
    meshScanWindowLow = (u16)MSEC_TO_UNITS(160, CONFIG_UNIT_0_625_MS); //orginal 3 80 160 240 //這裡修改 ScanWindow
