...
void TimeManager::ProcessTicks()
{
    ...
    additionalTicks -= seconds * ticksPerSecond; //find
}
...
void TimeManager::convertTimestampToString(char * buffer)
{
    ...
    //u32 msseconds = GetAdditionalTicks();

    snprintf(buffer, 100, "approx. %u years, %u days, %02uh:%02um:%02us,%05u ticks", years, days, hours, minutes, seconds);//find *30517578125/10000000000
}
