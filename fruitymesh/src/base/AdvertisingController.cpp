...
void AdvertisingController::Initialize()
{
    ...
    currentAdvertisingParams.interval = MSEC_TO_UNITS(32, CONFIG_UNIT_0_625_MS); // Advertising interval between 0x0020 and 0x4000 in 0.625 ms units (20ms to 10.24s), see @ref BLE_GAP_ADV_INTERVALS // orginal 100
