...
#define TOTAL_NUM_CONNECTIONS 6 //orginal 5 6 8 這裡是修改網路修改總連線數的地方
...
#define ACTIVATE_UART 0 //orginal 0
#endif
    ...
    : public RecordStorageEventListener
{
    ...
    public:
        ...
        static constexpr u16 meshAdvertisingIntervalLow = (u16)MSEC_TO_UNITS(32, CONFIG_UNIT_0_625_MS);// orginal 200

        //INITIATING
        //(20-1024) in 0.625ms units
        static constexpr u16 meshConnectingScanInterval = 120; //FIXME_HAL: 120 units = 75ms (0.625ms steps) orginal 120
        //(2.5-1024) in 0.625ms units
        static constexpr u16 meshConnectingScanWindow = 60; //FIXME_HAL: 60 units = 37.5ms (0.625ms steps) orginal 60
        //(0-...) in seconds
        static constexpr u16 meshConnectingScanTimeout = 2;  //orginal 2
        ...
        bool enableSinkRouting = true; // orginal false
        // ########### TIMINGS ################################################
        ...
        static constexpr u16 meshConnectionSupervisionTimeout = (u16)MSEC_TO_UNITS(1000, CONFIG_UNIT_10_MS);//orginal 1000
        ...
        static constexpr u16 meshConnectionLongTermAgeDs = 50; //orginal 50
        //Age penalty added for peripherals to stop central and peripheral
        //from requesting an update simultaneously.
        static constexpr u16 meshConnectionLongTermAgePeripheralPenaltyDs = 20; //orginal 20
#endif

        //Mesh discovery parameters
        //DISCOVERY_HIGH
        //(20-1024) (100-1024 for non connectable advertising!) Determines advertising interval in units of 0.625 millisecond.
        static constexpr u16 meshAdvertisingIntervalHigh = (u16)MSEC_TO_UNITS(32, CONFIG_UNIT_0_625_MS);//orginal 100
        ...
        static constexpr i8 defaultDBmTX = -4; //orginal 4 //這裡是修改TxPower的地方
...
#ifndef SIM_ENABLED
        static constexpr u8 totalInConnections = 3; //orginal 3 static constexpr
        static constexpr u8 totalOutConnections = 3; //orginal 3 static constexpr
        u8 meshMaxInConnections = 3; //orginal 2
        static constexpr u8 meshMaxOutConnections = 3; //orginal 3 static constexpr
#else
        u8 totalInConnections = 3; //orginal 3
        u8 totalOutConnections = 3; //orginal 3
        u8 meshMaxInConnections = 3; //orginal 2
        u8 meshMaxOutConnections = 3; //orginal 3 這裡修改meshMaxOutConnections的地方
#endif // SIM_ENABLED
